                    ...
                    >
                        ...
                        <div className="bg-[#00f3ff] text-black p-4 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-xl font-bold font-[Orbitron] tracking-widest">INCOMING TRANSMISSION</h2>
                            </div>
                            <div className="text-xs font-mono font-bold">PRIORITY: CRITICAL</div>
                        </div>
                        ...
                        <div className="p-8 font-mono text-[#00f3ff] relative">
                            ...
                            <div className="mb-6 border-b border-[#00f3ff]/30 pb-4">
                                <div className="text-xs text-[#00f3ff]/60 mb-1">MISSION ID</div>
                                <div className="text-2xl font-bold tracking-widest">OP-{String(lesson.id).padStart(3, '0')} // {lesson.title.toUpperCase()}</div>
                            </div>

                            <div className="mb-8 space-y-4">
                                <div>
                                    <div className="text-xs text-[#00f3ff]/60 mb-1">BRIEFING</div>
                                    <p className="text-lg leading-relaxed text-[#e0e0e0] border-l-4 border-[#00f3ff] pl-4 py-2 bg-[#00f3ff]/5">
                                        {lesson.briefing || "NO BRIEFING DATA AVAILABLE."}
                                    </p>
                                </div>

                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-[#00f3ff]/10 p-3 border border-[#00f3ff]/30">
                                        <div className="text-xs text-[#00f3ff]/60 mb-1">OBJECTIVE</div>
                                        <div className="text-sm text-white">{lesson.description}</div>
                                    </div>
                                    <div className="bg-[#00f3ff]/10 p-3 border border-[#00f3ff]/30">
                                        <div className="text-xs text-[#00f3ff]/60 mb-1">REWARD</div>
                                        <div className="text-sm text-[#ff00ff] font-bold">{lesson.points} XP CREDITS</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-end">
                                ...
                                >
                                    <span className="relative z-10 flex items-center gap-2">
                                        ACCEPT MISSION <CheckCircle size={20} />
                                    </span>
